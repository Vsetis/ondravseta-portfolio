        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 justify-between">
            <div className="order-2 md:order-1">
                <Link href={previewLink} target="_blank">
                    <div className="relative transition-all hover:scale-[101%] min-w-[100%] md:min-w-[550px] h-[250px] md:h-[380px] xl:h-[280px] rounded-[15px]  shadow-md">
                        <Image
            ...
            <div className="order-1 md:order-2 w-full xl:w-[40%]">
